...
def create(insurance: InsurancesRequest, db_session: Session, payload):
    ...
    try:
        ...
        query = text(
            "INSERT INTO insurances (insurance_name, person_id, policy_number, coverage_details, status, created_at, created_by, updated_at, updated_by) VALUES (:insurance_name, :person_id, :policy_number, :coverage_details, :status, :created_at, :created_by, :updated_at, :updated_by)"
        )
...
def update(insurance_id: int, insurance: InsurancesUpdateRequest, db_session: Session, payload):
    ...
    try:
        ...
        query = text(
            "UPDATE insurances SET insurance_name = :insurance_name, person_id = :person_id, policy_number = :policy_number, coverage_details = :coverage_details, status = :status, updated_at = :updated_at, updated_by = :updated_by WHERE insurance_id = :insurance_id"
        )
