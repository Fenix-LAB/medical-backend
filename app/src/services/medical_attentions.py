...
def update(
    ...
    try:
        ...
        return {
            "message": f"Medical Attention with id {medical_attention_id} updated successfully",
            "data": data_medical_attention,
        }
