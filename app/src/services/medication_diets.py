...
def create(medication_diet: MedicationDietsRequest, db_session: Session, payload):
    ...
    try:
        ...
        query = text(
            "INSERT INTO medication_diets (medication_type_id, company_id, medication_diet_name, generic_composition, indications, contraindications, status, created_at, created_by, updated_at, updated_by) VALUES (:medication_type_id, :company_id, :medication_diet_name, :generic_composition, :indications, :contraindications, :status, :created_at, :created_by, :updated_at, :updated_by)"
        )
...
def update(
    ...
    try:
        ...
        return {
            "message": f"Medication Diet with id {medication_diet_id} updated successfully",
            "data": data_medication_diet,
        }
